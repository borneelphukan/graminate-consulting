              ...
              <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                <div className="lg:w-1/2 text-center lg:text-left">
                  ...
                  <p className="mt-4 text-lg text-gray-600">
                    ...
                    affordable, and scalable software solutions, transforming
                    your business for today and tomorrow.
                  </p>
                </div>
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    <div className="w-24 h-24 mb-4 shadow-lg bg-white rounded-full flex items-center justify-center transition-transform duration-300 ease-in-out group-hover:scale-105">
                      <FontAwesomeIcon
                        icon={step.icon}
                        className="text-green-200 text-4xl"
                      />
                    </div>
              ...
              <div className="md:hidden relative mt-12 px-8">
                <div className="relative flex items-center justify-center">
                  <button
                    ...
                    className={`absolute left-0 -translate-x-full p-2 text-gray-300 hover:text-green-600 disabled:opacity-30 disabled:cursor-not-allowed transition-opacity duration-300 z-10`}
                  ...
                  <button
                    ...
                    className={`absolute right-0 translate-x-full p-2 text-gray-300 hover:text-green-200 disabled:opacity-30 disabled:cursor-not-allowed transition-opacity duration-300 z-10`}
